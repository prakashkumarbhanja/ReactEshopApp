...
const InfoSection = () => {
    ...
    const infoSection = [
        ...
        },
        {
            ...
            description: 'Full refund in case not satisfied'
        },
        {
        ...
        },
        {
            ...
            title: 'Discounr',
            description: 'Best Discount Available'
        }
    ]
  return (
    <div className='bg-white pb-8 pt-12'>
        ...
        {infoSection.map((item, index)=>(
            ...
            transition transition-transform duration-300 hover:scale-105 cusrsor-pointer'>
                {item.icon}
